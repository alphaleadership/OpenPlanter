...
def parse_env_file(path: Path) -> CredentialBundle:
    ...
    return CredentialBundle(
        ...
        or None,
        gemini_api_key=(env.get("GEMINI_API_KEY") or env.get("OPENPLANTER_GEMINI_API_KEY") or "").strip() or None,
...
def credentials_from_env() -> CredentialBundle:
    return CredentialBundle(
        ...
        or None,
        gemini_api_key=(
            os.getenv("OPENPLANTER_GEMINI_API_KEY") or os.getenv("GEMINI_API_KEY") or ""
        ).strip()
        or None,
